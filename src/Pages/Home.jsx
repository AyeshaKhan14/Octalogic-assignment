...
export const Home = () => {
  return (
    <main className='border-2 border-blue-900 h-screen w-full flex'>
      {/* Side Menu */}
      <section className='grid grid-cols-12 gap-6'>
        ...
        <div className='col-span-10 border w-[1360px] flex flex-col gap-8 border-black mt-6'>
          {/* overview */}
          ...
          {/* enrolments */}
          <div className='border h-[200px] flex flex-col gap-2'>
            <div className='flex flex-row items-center justify-between'>
              <h1 className='font-sanss font-bold text-light text-sm tracking-[0.4px]'>
                LATEST ENROLMENTS
              </h1>
              <div className=' text-sm text-secondary'>View All Courses</div>
            </div>
            <EnrolTable />
          </div>
          {/* best student */}
